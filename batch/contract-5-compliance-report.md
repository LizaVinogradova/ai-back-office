# Compliance report: contract-5.md vs правовая база

## Область проверки

Проверен договор `C:/Users/e.zhilyakova/Documents/ai-back-office 2/batch/contract-5.md` относительно правовой базы из папки `regulations/`:
